...
const GpuComputeFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_gpucompute_free(ptr >>> 0, 1));

export class GpuCompute {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(GpuCompute.prototype);
        obj.__wbg_ptr = ptr;
        GpuComputeFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        GpuComputeFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_gpucompute_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.gpucompute_new();
        return ret;
    }
    /**
     * @param {number} width
     ...
     * @returns {Promise<any>}
     */
    render_3d_frame(width, height, time) {
        const ret = wasm.gpucompute_render_3d_frame(this.__wbg_ptr, width, height, time);
        return ret;
    }
    /**
     * @returns {Promise<any>}
     */
    run_ml_inference_test() {
        const ret = wasm.gpucompute_run_ml_inference_test(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     * @returns {Promise<any>}
     */
    parallel_process(data, operation, param) {
        const ptr0 = passArray32ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.gpucompute_parallel_process(this.__wbg_ptr, ptr0, len0, operation, param);
        return ret;
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_gpucompute_new = function(arg0) {
        const ret = GpuCompute.__wrap(arg0);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wgeneric_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
